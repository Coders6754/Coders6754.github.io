...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.download = "Anjali-Sinha_Resume.pdf";
        link.href = resume;
        link.click();
        window.open(
            "https://drive.google.com/file/d/14Qxsm1caXqT1PojTP91Zd-w49P4BSvbQ/view?usp=sharing",
            "_blank"
        );
    };
        ...
        <>
            <div id='nav-menu'>
                ...
                <div id="smallScreenNavbar">
                    ...
                    <img src={burger ? "/cross.svg" : "./Images/burgerMenu.svg"} alt="" />
                    </div>
                </div>
            </div >
            {
